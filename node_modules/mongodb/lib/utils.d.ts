 ...
 * @internal
 */
export declare type TopologyProvider = MongoClient | ClientSession | FindCursor | AbstractCursor | Collection<any> | Db;
/**
...
export declare function parsePackageVersion({ version }: {
    version: string;
}): {
    major: number;
    minor: number;
...
export declare function commandSupportsReadConcern(command: Document, options?: Document): boolean;
/** A utility function to get the instance of mongodb-client-encryption, if it exists. */
export declare function getMongoDBClientEncryption(): {
 ...
 */
export declare function compareObjectId(oid1?: ObjectId, oid2?: ObjectId): 0 | 1 | -1;
export {};
